...
class KnightPossibleMovesCalculator {
	static execute(
		board,
		startRow,
		startCol,
		...
		this.tryAddCoordinate( board, startRow - 2, startCol - 1, alignment, targetSet );
		this.tryAddCoordinate( board, startRow - 1, startCol - 2, alignment, targetSet );
		this.tryAddCoordinate( board, startRow - 2, startCol + 1, alignment, targetSet );
		this.tryAddCoordinate( board, startRow - 1, startCol + 2, alignment, targetSet );
		this.tryAddCoordinate( board, startRow + 2, startCol - 1, alignment, targetSet );
		this.tryAddCoordinate( board, startRow + 1, startCol - 2, alignment, targetSet );
